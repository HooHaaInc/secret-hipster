...
namespace BountyHunter
{
	public class GameObject
	{
		...
		public Vector2 WorldBottomCenter{
			get { return new Vector2(
					(int)worldLocation.X + (int)(frameWidth/2),
					(int)worldLocation.Y + (int)CollisionRectangle.Y); 
			}
		}
		...
		private Vector2 horizontalCollisionTest(Vector2 moveAmount){
			...
			Vector2 mapCell1 = TileMap.GetCellAtPixel (corner1);
			Vector2 mapCell2 = TileMap.GetCellAtPixel (corner2);
